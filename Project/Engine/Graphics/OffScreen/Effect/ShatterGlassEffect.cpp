...
namespace MiiEngine {
	...
	void ShatterGlassEffect::Draw(ID3D12GraphicsCommandList* commandList) {
		...
		// パイプラインの設定
		Service::Render::SetPSO(commandList, PipelineType::ShatterGlass, BlendMode::kBlendModeNone);
		...
		Service::Render::SetGraphicsRootDescriptorTable(commandList, 1, textureKeyName_);
