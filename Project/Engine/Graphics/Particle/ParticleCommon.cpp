...
namespace MiiEngine {
	...
	/// 初期化
	///-------------------------------------------///
	void ParticleCommon::Initialize(ID3D12Device* device, const uint32_t kNumMaxInstance) {
	...
	///-------------------------------------------///
	// material
	void ParticleCommon::SetMaterialData(const Vector4& color, const Matrix4x4& uvTransform) {
