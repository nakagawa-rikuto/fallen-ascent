...
void PlayerUI::Initialize() {
	...
	// 移動UIの初期化
	moveUI_ = std::make_shared<Object2d>();
	...
	// 左スティックUIの初期化
	leftStick_ = std::make_shared<Object2d>();
	...
	// カメラUIの初期化
	cameraUI_ = std::make_shared<Object2d>();
	...
	// 右スティックUI初期化
	rightStick_ = std::make_shared<Object2d>();
	...
	// 攻撃UIの初期化
	attackUI_ = std::make_shared<Object2d>();
	...
	// XボタンUIの初期化
	xButton_ = std::make_shared<Object2d>();
	...
	// 回避UIの初期化
	avoidanceUI_ = std::make_shared<Object2d>();
	...
	// AボタンUIの初期化
	aButton_ = std::make_shared<Object2d>();
